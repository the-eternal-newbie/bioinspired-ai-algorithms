...
def main():
    abc = artificial_bee_colony_optimization(food_sources=350, iterations=10, min_values=[-500, -500], max_values=[
        500, 500], employed_bees=20, outlookers_bees=20, limit=40, target_function=schwefel)

    return(schwefel_2([abc[1], abc[2]]))
